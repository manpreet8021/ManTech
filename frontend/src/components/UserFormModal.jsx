...
import { userFormSchema } from '../validation/userSchemas'
      ...
      <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4" noValidate>
        ...
        <div>
          ...
          <input
            ...
            className={`w-full rounded-lg border px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-1 disabled:bg-slate-50 disabled:text-slate-500 ${
              errors.email
                ? 'border-rose-300 focus:border-rose-500 focus:ring-rose-500'
                : 'border-slate-300 focus:border-indigo-500 focus:ring-indigo-500'
            }`}
